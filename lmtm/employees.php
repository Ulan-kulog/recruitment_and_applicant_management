            ...
            <body class="bg-[#FFF6E8] text-[#4E3B2A] font-[Georgia]">
                ...
                <div class="p-10">
                    ...
                    <div class="overflow-x-auto">
                        ...
                        <td class='px-6 py-4 flex gap-2 rounded-r-lg'>
                            <button class='px-4 py-2 bg-[#FFF6E8] border-2 border-[#594423] rounded-md hover:bg-[#F7E6CA]' onclick=\"openEditModal({$row['EmployeeID']}, '{$row['FullName']}', '{$row['Email']}')\"><i class='bx bx-edit'></i> Edit</button>
                            <button class='px-4 py-2 bg-[#594423] text-white rounded-md hover:bg-[#402f1c]' onclick=\"deleteEmployee({$row['EmployeeID']})\"><i class='bx bx-trash'></i> Delete</button>
