    ...
    <div class="flex justify-between items-center border-b border-[#594423] pb-2">
        ...
        <nav>
            <ul class="flex items-center space-x-4">
                <li><a href="/manager/" class="text-[#594423] font-semibold">Home</a></li>
                <!-- <li><a href="/hr/job-create" class="text-[#594423] font-semibold">Post Job</a></li> -->
                <li><a href="/manager/applicants" class="text-[#594423] font-semibold">Applicants</a></li>
                <li>
                    <div class="dropdown dropdown-end">
                        ...
                        <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm">
                            ...
                            <li><a href="/manager/profile" class="text-[#594423] font-semibold"><i class="fa-solid fa-gear"></i>User Settings</a></li>
                        ...
                        <?php foreach ($notifications as $notification) : ?>
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <?php endif ?>
                                    <a href="/manager/applicant-notification?id=<?= $notification['id'] ?>" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white  <?= $notification['status'] == 'unread' ? 'text-white font-semibold' : '' ?>"><?= $notification['message'] ?></a>
                                </div>
                            </li>
                        <?php endforeach ?>
                    <?php endif ?>
