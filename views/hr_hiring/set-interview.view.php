...
<div class="my-5">
    <a href="/hr_hiring/applicants" class="text-blue-500 hover:underline px-4 flex items-center"><box-icon name='left-arrow-alt'></box-icon> back to applicants page</a>
</div>
<main class="max-w-6xl mx-auto p-6 flex-grow">
    ...
    <div class="overflow-x-auto rounded-box mt-5 bg-white shadow-lg ">
        <table class="table">
            <thead class="bg-[#594423] text-white">
                <tr>
                    <th>Posting ID</th>
