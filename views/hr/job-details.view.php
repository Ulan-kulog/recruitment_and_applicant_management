...
<main class="max-w-5xl mx-auto mt-10 mb-10 p-10 rounded-lg bg-[#F7E6CA] shadow-lg border border-[#594423]">
    <div class="p-10 mb-10 flex flex-col justify-center max-w-5xl">
        ...
        <div class="mt-10">
            <a href="/hr/" class="text-[#594423] font-medium hover:text-gray-800 flex items-center">
