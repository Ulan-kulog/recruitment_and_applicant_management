...
//   $query = "SELECT Name FROM user_account WHERE username = ?";
          ...
          <div
            ...
            <ul class="space-y-1">
              ...
              <li>
                <a
                  href="#"
                  class="text-sm text-gray-800 hover:text-blue-600 hover:ms-2 duration-300 ease-out pr-5 py-2">applicationstatus</a>
              </li>
              <li>
                <a
                  href="#"
        ...
        <div class="relative" id="notif-container">
          ...
          <div id="notif-dropdown"
            ...
            <div class="max-h-60 overflow-y-auto">
              ...
              $query = "SELECT Action FROM user_audit_trail ORDER BY User_Audit_Trail_ID DESC LIMIT 5";
              $result = mysqli_query($conn, $query);

              if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                  echo '<div class="px-4 py-2 text-sm text-gray-600 border-b">' . htmlspecialchars($row['Action']) . '</div>';
                }
              } else {
                echo '<div class="px-4 py-2 text-sm text-gray-600">No new notifications</div>';
              }
              ?>
            </div>
          </div>
